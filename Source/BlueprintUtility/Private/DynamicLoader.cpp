...
//	
//
//	//TFunction Task =  LoadImageFromDisk(ImagePath);
//	
//	//auto Result = Async(EAsyncExecution::Thread, MoveTemp(Task));
//
//
//
//	return Async<UTexture2D*>(EAsyncExecution::ThreadPool, [=]() { return MoveTemp((LoadImageFromDisk(ImagePath)); }, CompletionCallback);
//}
//
